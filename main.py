    ...
    Config Diff Wyr5zv
    ==================
    Developer-friendly CLI that helps you clean projects in seconds.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you clean projects in seconds.")
